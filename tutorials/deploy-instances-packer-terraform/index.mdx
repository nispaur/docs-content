...
1. Download [Packer](https://www.packer.io/downloads.html) for your Operating system. If you want to have some specific configuration, you can also [build the application](https://www.packer.io/intro/getting-started/install.html#compiling-from-source) from source.
...
3. Save the file and launch packer:
  ...
  <Lightbox src="scaleway-packer-image.png" alt="" />
